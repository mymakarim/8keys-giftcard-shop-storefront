        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-24 pb-12">
          <div className="text-center mb-12">
            <h1 className="text-4xl md:text-6xl font-gaming font-bold mb-4">
              ...
              <span className="transition-colors duration-300 dark:text-white light:text-gray-900"> Gift Cards</span>
            </h1>
            <p className="text-xl max-w-2xl mx-auto transition-colors duration-300 dark:text-gray-300 light:text-gray-600">
              Choose from our extensive collection of gaming gift cards. 
              All purchases are instant and secure with cryptocurrency payments.
            </p>
          </div>
